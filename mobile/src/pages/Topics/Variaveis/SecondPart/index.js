  ...
  return(
    <>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.textSec}>
          Usar o seu nome em outras partes do código é o mesmo que usar seu valor:
        </Text>
        <View style={styles.code}>
          <Text style={styles.textSec}>
        ...
        <View style={styles.code}>
          <Text style={styles.textSec}>
            console.<Text style={styles.greenHighlight}>log</Text>(numero + numero);
          </Text>
          <Text style={styles.comment}>
            // Exibe 10.6
          </Text>
        ...
        <Text style={styles.textSec}>
          Uma variável pode ter um novo valor atribuído a ela em qualquer 
          parte do código:
        </Text>
        <View style={styles.code}>
          <Text style={styles.textSec}>
          ...
          <Text style={styles.comment}>
            // Novo valor atribuído à variável
          </Text>
        ...
        <Text style={styles.textSec}>
          Variáveis não precisam obrigatoriamente receber um valor assim que 
          são declaradas.
        </Text>
        <View style={styles.code}>
          <Text style={styles.textSec}>
      ...
      <TopicFooter nextScreen="FinishTopic" topic="Variáveis"/>
    </>
  );
}
